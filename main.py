...
def target_select(target_button):
    ...
    i_target = target_buttons_list.index(target_button)
    target_pos = target_pos_list[i_target]
    selected_target = target_list[i_target]
...
target_list = ["bull", "t20", "t19",
               "t18", "d20", "d16", "d12", "d10", "d8"]
target_buttons_list = []
selected_target = target_list[0]
i_target = 0
target_pos = Vec3(0.0035, 0.012, -16.79)
target_pos_list = [
    Vec3(0.0035, 0.012, -16.79),
    Vec3(0.0035, 0.114, -16.79),
    Vec3(-0.027, -0.084, -16.79),
    Vec3(0.061, 0.095, -16.79),
    Vec3(0.0035, 0.178, -16.79),
    Vec3(-0.13, -0.084, -16.79),
    Vec3(-0.094, 0.142, -16.79),
    Vec3(0.16, -0.04, -16.79),
    Vec3(-0.151, -0.04, -16.79)
]
